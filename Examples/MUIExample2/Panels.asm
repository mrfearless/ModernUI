...
Panel1Proc PROC hWin:HWND,uMsg:UINT,wParam:WPARAM,lParam:LPARAM
    ...
    .IF eax==WM_INITDIALOG
        ...
        ;-----------------------------------------------------------------------------------------------------
        Invoke GetDlgItem, hWin, IDC_BTNCONFIRMYES
        ...
        Invoke GetDlgItem, hWin, IDC_BTNCONFIRMNO
        ...
        ;-----------------------------------------------------------------------------------------------------        
        Invoke GetDlgItem, hWin, IDC_TEXTCONFIRMCANCEL
...
Panel2Proc PROC hWin:HWND,uMsg:UINT,wParam:WPARAM,lParam:LPARAM
    ...
    .IF eax==WM_INITDIALOG
        ...
        ;-----------------------------------------------------------------------------------------------------
        Invoke GetDlgItem, hWin, IDC_BTNCANCEL
        ...
        ;-----------------------------------------------------------------------------------------------------        
        Invoke GetDlgItem, hWin, IDC_TEXTINSTALLING
        ...
        ;-----------------------------------------------------------------------------------------------------
        Invoke GetDlgItem, hWin, IDC_MUIPD
...
Panel3Proc PROC hWin:HWND,uMsg:UINT,wParam:WPARAM,lParam:LPARAM
    ...
    .IF eax==WM_INITDIALOG
        ...
        ;-----------------------------------------------------------------------------------------------------
        Invoke GetDlgItem, hWin, IDC_BTNCHOOSENEXT
        ...
        Invoke GetDlgItem, hWin, IDC_BTNCHOOSECANCEL
        ...
        ;-----------------------------------------------------------------------------------------------------        
        Invoke GetDlgItem, hWin, IDC_TEXTCHOOSE
...
Panel4Proc PROC hWin:HWND,uMsg:UINT,wParam:WPARAM,lParam:LPARAM
    ...
    .IF eax==WM_INITDIALOG
        ...
        ;-----------------------------------------------------------------------------------------------------
        Invoke GetDlgItem, hWin, IDC_BTNFINISH
        ...
        ;-----------------------------------------------------------------------------------------------------        
        Invoke GetDlgItem, hWin, IDC_TEXTFINISHED
