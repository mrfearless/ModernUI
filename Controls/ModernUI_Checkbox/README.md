# ![](../../assets/ModernUI_Checkbox48x48.png) ModernUI_Checkbox
...
For the x64 version of the ModernUI_Checkbox control, visit [here](https://github.com/mrfearless/ModernUI64/tree/master/Controls/ModernUI_Checkbox).
...
```
* Add the ModernUI_Checkbox control to your project:
```assembly
