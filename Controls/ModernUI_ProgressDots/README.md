# ![](../../assets/ModernUI_ProgressDots48x48.png) ModernUI_ProgressDots
...
For the x64 version of the ModernUI_ProgressDots control, visit [here](https://github.com/mrfearless/ModernUI64/tree/master/Controls/ModernUI_ProgressDots).
...
```
* Add the ModernUI_ProgressDots control to your project:
```assembly
