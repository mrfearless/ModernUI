...
;
; And then adapted from DrawTextEXT by fearless 
; 
...
_HTMLCODE_QUOTE         PROTO :DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD  ; hWin, hdc, hFont, lplpszStart, lpNewCount, dwTokenLength, lpRect, dwTagType
_HTMLCODE_PRE           PROTO :DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD  ; hWin, hdc, hFont, lplpszStart, lpNewCount, dwTokenLength, lpRect, dwTagType
...
_HTMLCODE_COLOR         PROTO :DWORD,:DWORD,:DWORD,:DWORD                       ; hWin, hdc, dwTag, lpszStart
_HTMLCODE_FONT          PROTO :DWORD,:DWORD,:DWORD,:DWORD                       ; hWin, hdc, dwTag, lpszStart
_HTMLCODE_HR            PROTO :DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD  ; hWin, hdc, dwLeft, dwTop, dwHeight, dwMaxWidth, dwLineHeight
_HTMLCODE_LIST          PROTO :DWORD,:DWORD,:DWORD,:DWORD                       ; hWin, hdc, hFont, dwTag 
_HTMLCODE_LISTITEM      PROTO :DWORD,:DWORD,:DWORD,:DWORD,:DWORD                ; hWin, hdc, hFont, lpRect, dwNewFormat
...
_BBCODE_CODE            PROTO :DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD  ; hWin, hdc, hFont, lplpszStart, lpNewCount, dwTokenLength, lpRect
_BBCODE_QUOTE           PROTO :DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD  ; hWin, hdc, hFont, lplpszStart, lpNewCount, dwTokenLength, lpRect, dwTagType
_BBCODE_COLOR           PROTO :DWORD,:DWORD,:DWORD,:DWORD                       ; hWin, hdc, dwTag, lpszStart
_BBCODE_LIST            PROTO :DWORD,:DWORD,:DWORD,:DWORD                       ; hWin, hdc, hFont, dwTag 
_BBCODE_LISTITEM        PROTO :DWORD,:DWORD,:DWORD,:DWORD,:DWORD                ; hWin, hdc, hFont, lpRect, dwNewFormat
...
; Utility Functions:
DteInfoSet              PROTO :DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD,:DWORD
...
ColorStackPush          PROTO :DWORD,:DWORD,:DWORD                              ; hWin, hdc, clr
ColorStackPop           PROTO :DWORD,:DWORD                                     ; hWin, hdc
ParseColor              PROTO :DWORD                                            ; String
HexDigit                PROTO :DWORD                                            ; lpCharHex
ListStackPush           PROTO :DWORD,:DWORD,:DWORD,:DWORD                       ; hWin, dwListType, dwItemIndent, dwBulletIndent
ListStackPop            PROTO :DWORD,:DWORD,:DWORD,:DWORD                       ; hWin, lpdwListType, lpdwItemIndent, lpdwBulletIndent
ListStackPeek           PROTO :DWORD,:DWORD,:DWORD,:DWORD                       ; hWin, lpdwListType, lpdwItemIndent, lpdwBulletIndent
ListStackSetCounter     PROTO :DWORD,:DWORD                                     ; hWin, dwValue
...
;------------------------------------------------------------------------------
DrawHTMLCODE PROC USES EBX ECX EDX hWin:DWORD, hdc:DWORD, lpString:DWORD, nCount:DWORD, lpRect:DWORD, uFormat:DWORD
    ...
    LOCAL rect:RECT
    LOCAL nSize:POINT
    LOCAL hfontSpecial:DWORD
    LOCAL DteInfo:DTEINFO
    ...
    Invoke MUIGetIntProperty, hWin, @TextPtrFontSpecial
    .IF eax == 0 ; alloc mem for fonts
        mov eax, FV_NUMBER
    ...
    ; alloc mem for stacks outside of this function
    ...
    Invoke MUIGetIntProperty, hWin, @TextHyperLinkControl
    mov hDTELink, eax

    .IF hDTELink != NULL ; Already exists, make sure its sized to fit our area
        IFDEF DEBUG32
    ...
    .WHILE TRUE
        ...
        Invoke MUIGetIntProperty, hWin, @TextListStackIndex
        mov ListLevel, eax    
        ...
        .ELSEIF eax == tPRE
            ...
            .IF eax == 0 ; <pre>
                ...
                Invoke _HTMLCODE_PRE, hWin, hdc, hfontBase, Addr lpszStart, Addr NewCount, nTokenLength, Addr rect, GETTAG_PRE
                mov nSize.x, eax
        ...
        .ELSEIF eax == tCODE
            ...
            .IF eax == 0 ; <code>
                ...
                Invoke _HTMLCODE_PRE, hWin, hdc, hfontBase, Addr lpszStart, Addr NewCount, nTokenLength, Addr rect, GETTAG_CODE
                ;mov XPos, eax
                ;mov nSize.x, eax
        ...
        .ELSEIF eax == tQUOTE1 || eax == tQUOTE2 || eax == tQUOTE3
            ...
            .IF eax == 0 ; <q>, <quote> or <blockq>
                ...
                Invoke _HTMLCODE_QUOTE, hWin, hdc, hfontBase, Addr lpszStart, Addr NewCount, nTokenLength, Addr rect, Tag
        ...
        .ELSEIF eax == tLIST || eax == tLISTO ; unordered list or orderded list
            ...
            .IF eax == 0 ; <ul> or <ol>
                ...
                Invoke _HTMLCODE_LIST, hWin, hdc, hfontBase, Tag
            ...
            .ELSE ; </ul> or <ol>
                ...
                Invoke ListStackPop, hWin, NULL, NULL, NULL 
                .IF Tag == tLISTO
                    ;Invoke ListStackSetCounter, 1, Addr ListStack, ListLevel
                    Invoke ListStackSetCounter, hWin, 1
                .ENDIF
                ;mov dwListCounter, 1
                Invoke SelectObject, hdc, hfontBase
            .ENDIF
        ...
        .ELSEIF eax == tLISTITEM && ListLevel > 0
            ...
            .IF eax == 0 ; <li>
                ...
                Invoke _HTMLCODE_LISTITEM, hWin, hdc, hfontBase, Addr rect, NewFormat
                mov XPos, eax
        ...
        .ELSEIF eax == tHR
            ...
            .IF eax == 0 ; <hr>
                ...
                .IF eax != DT_SINGLELINE
                    ...
                    add nHeight, eax
                    mov XPos, 0
                    Invoke _HTMLCODE_HR, hWin, hdc, nLeft, nTop, nHeight, nMaxWidth, nLineHeight
                    mov eax, nLineHeight
                    sub eax, 2
                    add nHeight, eax
                    mov XPos, 0                    
        ...
        ;------------------------------------------------------------------
        .ELSEIF eax == tCOLOR
            Invoke _HTMLCODE_COLOR, hWin, hdc, Tag, lpszStart

        ;------------------------------------------------------------------
        .ELSEIF eax == tFONT
            Invoke _HTMLCODE_FONT, hWin, hdc, Tag, lpszStart
        ...
        .ELSE ; Default
            ...
            .ELSE ; otherwise we assume it was a word (or an unknown tag) to draw
                ...
                .IF dwListItemMode == 1 
                    ...
                    Invoke ListStackPeek, hWin, NULL, Addr dwListIndent, Addr dwBulletIndent
                    mov eax, XPos
                ...
                .IF eax > nMaxWidth && bWhiteSpace == TRUE
                    ...
                    .IF eax == DT_WORDBREAK
                        .IF dwListItemMode == 1
                            ...
                            Invoke ListStackPeek, hWin, NULL, Addr dwListIndent, NULL
                            ; word wrap
                            mov eax, nLineHeight
                            add eax, 2d
                            add nHeight, eax
...
;------------------------------------------------------------------------------
_HTMLCODE_PRE PROC USES EBX hWin:DWORD, hdc:DWORD, hFont:DWORD, lplpszStart:DWORD, lpNewCount:DWORD, dwTokenLength:DWORD, lpRect:DWORD, dwTagType:DWORD ;dwLeft:DWORD, dwTop:DWORD, lpdwHeight:DWORD, dwMaxWidth:DWORD
    ...
    LOCAL nLineHeight:DWORD
    LOCAL nHeight:DWORD
    LOCAL dwRGBCodeTextColor:DWORD
    LOCAL dwRGBCodeBackColor:DWORD
    LOCAL hBrush:DWORD
    LOCAL SavedDC:DWORD
    LOCAL rect:RECT
    LOCAL nSize:POINT
    ...
    .IF eax != NULL
        ...
        mov hBrush, eax
        Invoke SetDCBrushColor, hdc, dwRGBCodeBackColor        
...
;------------------------------------------------------------------------------
_HTMLCODE_QUOTE PROC USES EBX hWin:DWORD, hdc:DWORD, hFont:DWORD, lplpszStart:DWORD, lpNewCount:DWORD, dwTokenLength:DWORD, lpRect:DWORD, dwTag:DWORD
    LOCAL lpTagContentText:DWORD
    LOCAL nTagContentLength:DWORD
    ...
    LOCAL nLineHeight:DWORD
    LOCAL nHeight:DWORD
    LOCAL dwRGBQuoteTextColor:DWORD
    LOCAL dwRGBQuoteBackColor:DWORD
    LOCAL hBrush:DWORD
    LOCAL SavedDC:DWORD    
    LOCAL rect:RECT
    LOCAL nSize:POINT
    ...
    .IF eax != NULL
        ...
        Invoke GetStockObject, DC_BRUSH
        mov hBrush, eax
        Invoke SetDCBrushColor, hdc, dwRGBQuoteBackColor        
        Invoke FillRect, hdc, Addr rect, hBrush
        Invoke RestoreDC, hdc, SavedDC
        .IF hBrush != 0
            Invoke DeleteObject, hBrush
...
; Returns in eax 0
;------------------------------------------------------------------------------
_HTMLCODE_COLOR PROC hWin:DWORD, hdc:DWORD, dwTag:DWORD, lpszStart:DWORD
    ...
    .IF eax == 0 ; <color>
        ...
        mov dwRGB, eax
        Invoke ColorStackPush, hWin, hdc, dwRGB
    .ELSE ; </color>
        Invoke ColorStackPop, hWin, hdc
    .ENDIF
    xor eax, eax
    ret
...
; Returns in eax 0
;------------------------------------------------------------------------------
_HTMLCODE_FONT PROC USES EBX hWin:DWORD, hdc:DWORD, dwTag:DWORD, lpszStart:DWORD
    LOCAL lpColString:DWORD
    LOCAL dwRGB:DWORD
...
; Returns in eax 0
;------------------------------------------------------------------------------
_HTMLCODE_HR PROC USES EBX hWin:DWORD, hdc:DWORD, dwLeft:DWORD, dwTop:DWORD, dwHeight:DWORD, dwMaxWidth:DWORD, dwLineHeight:DWORD
    LOCAL hPen:DWORD
    LOCAL hOldPen:DWORD
    LOCAL rect:RECT
    LOCAL SavedColor:DWORD
    LOCAL dwRGBHorzRuleColor:DWORD
...
; Returns in eax 0
;------------------------------------------------------------------------------
_HTMLCODE_LIST PROC USES EBX hWin:DWORD, hdc:DWORD, hFont:DWORD, dwTag:DWORD 
    LOCAL nSize:POINT
    LOCAL nWidthOfSpace:DWORD
    LOCAL dwListLevel:DWORD
    ...
    Invoke ListStackPush, hWin, dwListType, dwListIndent, dwListBulletIndent
    xor eax, eax
    ret
_HTMLCODE_LIST ENDP
...
;------------------------------------------------------------------------------
_HTMLCODE_LISTITEM PROC USES EBX hWin:DWORD, hdc:DWORD, hFont:DWORD, lpRect:DWORD, dwNewFormat:DWORD
    LOCAL nSize:POINT
    LOCAL rect:RECT
    LOCAL nLeft:DWORD
    LOCAL nTop:DWORD
    ...
    .IF eax != DT_SINGLELINE
        ...
        Invoke ListStackPeek, hWin, Addr dwListType, Addr dwListIndent, Addr dwListBulletIndent
        ...
        .ELSE ; draw number
            ...
            Invoke ListStackSetCounter, hWin, dwListType
        .ENDIF
        Invoke SelectObject, hdc, hFont
...
; Returns in eax height of text drawn similar to DrawText
;------------------------------------------------------------------------------
DrawBBCODE PROC USES EBX ECX EDX hWin:DWORD, hdc:DWORD, lpString:DWORD, nCount:DWORD, lpRect:DWORD, uFormat:DWORD
    LOCAL lpszStart:DWORD
    LOCAL nLeft:DWORD
    LOCAL nTop:DWORD
    LOCAL nRight:DWORD
    ...
    .WHILE TRUE
        ...
        .ELSEIF eax == tCODE ; [code] or [/code]
            ...
            .IF eax == 0 ; [code]
                ...
                Invoke _BBCODE_CODE, hWin, hdc, hfontBase, Addr lpszStart, Addr NewCount, nTokenLength, Addr rect
        ...
        .ELSEIF eax == tQUOTE1 || eax == tQUOTE2 ; [q], [quote]
            ...
            .IF eax == 0 ; [q], [quote]
                ...
                Invoke _BBCODE_QUOTE, hWin, hdc, hfontBase, Addr lpszStart, Addr NewCount, nTokenLength, Addr rect, Tag
        ...
        .ELSEIF eax == tLIST || eax == tLISTO ; <ul> or <ol> unordered list or orderded list
            ...
            .IF eax == 0 ; <ul> or <ol>
                ...
                Invoke _BBCODE_LIST, hWin, hdc, hfontBase, Tag
        ...
        .ELSEIF eax == tLISTITEM && ListLevel > 0 ; [li] or [*]
            ...
            .IF eax == 0 ; [li]
                ...
                Invoke _BBCODE_LISTITEM, hWin, hdc, hfontBase, Addr rect, NewFormat
                mov XPos, eax
        ...
        .ELSEIF eax == tCOLOR ; [color] or [/color]
            ;PrintText 'tCOLOR'
            Invoke _BBCODE_COLOR, hWin, hdc, Tag, lpszStart
...
; point to next token, usually: </pre> or </code>
;------------------------------------------------------------------------------
_BBCODE_CODE PROC USES EBX hWin:DWORD, hdc:DWORD, hFont:DWORD, lplpszStart:DWORD, lpNewCount:DWORD, dwTokenLength:DWORD, lpRect:DWORD
    LOCAL lpTagContentText:DWORD
    LOCAL nTagContentLength:DWORD
    LOCAL nWidthOfSpace:DWORD
    LOCAL nLeft:DWORD
...
; point to next token, usually: </q> or </quote> or </blockq>
;------------------------------------------------------------------------------
_BBCODE_QUOTE PROC USES EBX hWin:DWORD, hdc:DWORD, hFont:DWORD, lplpszStart:DWORD, lpNewCount:DWORD, dwTokenLength:DWORD, lpRect:DWORD, dwTag:DWORD
    LOCAL lpTagContentText:DWORD
    LOCAL nTagContentLength:DWORD
    LOCAL lpWideTagContentText:DWORD
    LOCAL nWideTagContentLength:DWORD    
...
; Returns in eax 0
;------------------------------------------------------------------------------
_BBCODE_COLOR PROC hWin:DWORd, hdc:DWORD, dwTag:DWORD, lpszStart:DWORD
    LOCAL lpColString:DWORD
    LOCAL dwRGB:DWORD
...
; Returns in eax 0
;------------------------------------------------------------------------------
_BBCODE_LIST PROC USES EBX hWin:DWORD, hdc:DWORD, hFont:DWORD, dwTag:DWORD 
    LOCAL nSize:POINT
    LOCAL nWidthOfSpace:DWORD
    LOCAL dwListLevel:DWORD
    LOCAL dwListType:DWORD
...
; height of bullets or numbers drawn.
;------------------------------------------------------------------------------
_BBCODE_LISTITEM PROC USES EBX hWin:DWORD, hdc:DWORD, hFont:DWORD, lpRect:DWORD, dwNewFormat:DWORD
    LOCAL nSize:POINT
    LOCAL rect:RECT
    LOCAL nLeft:DWORD
    LOCAL nTop:DWORD
...
MUI_ALIGN
;------------------------------------------------------------------------------
; Set data into DTEINFO strcuture
;------------------------------------------------------------------------------
DteInfoSet PROC USES EBX lpStringPos:DWORD, dwNewCount:DWORD, dwTokenLength:DWORD, dwLineHeight:DWORD, dwHeight:DWORD, dwXPos:DWORD, dwMaxWidth:DWORD, lpRect:DWORD, lpDteInfo:DWORD

    mov ebx, lpDteInfo

    mov eax, lpStringPos
    mov [ebx].DTEINFO.lpStringPos, eax
    
    mov eax, dwNewCount
    mov [ebx].DTEINFO.dwNewCount, eax

    mov eax, dwTokenLength
    mov [ebx].DTEINFO.dwTokenLength, eax
    
    mov eax, dwLineHeight
    mov [ebx].DTEINFO.dwLineHeight, eax
    
    mov eax, dwHeight
    mov [ebx].DTEINFO.dwHeight, eax
    
    mov eax, dwXPos
    mov [ebx].DTEINFO.dwXPos, eax
    
    mov eax, dwMaxWidth
    mov [ebx].DTEINFO.dwMaxWidth, eax
    
    mov eax, lpRect
    lea ebx, [ebx].DTEINFO.rect
...
; Returns in eax TRUE if success or FALSE if error
;------------------------------------------------------------------------------
ColorStackPush PROC USES EBX ECX hWin:DWORD, hdc:DWORD, clr:DWORD
    LOCAL dwColorStackIndex:DWORD
    LOCAL ptrColorStack:DWORD
    ...
    Invoke MUIGetIntProperty, hWin, @TextPtrColorStack
    .IF eax == 0
        mov eax, FALSE
        ret
    .ENDIF
    mov ptrColorStack, eax
    
    Invoke MUIGetIntProperty, hWin, @TextColorStackIndex
    mov dwColorStackIndex, eax

    .IF eax < COLORSTACK_SIZE
        Invoke GetTextColor, hdc
        mov ebx, ptrColorStack ; get ptr to stack 
        mov ecx, dwColorStackIndex
        mov dword ptr [ebx + ecx *DWORD], eax ; save color to stack
        inc dwColorStackIndex ; inc StackTop
        Invoke MUISetIntProperty, hWin, @TextColorStackIndex, dwColorStackIndex
    .ENDIF
...
; Returns in eax TRUE if success or FALSE if error
;------------------------------------------------------------------------------
ColorStackPop PROC USES EBX ECX hWin:DWORD, hdc:DWORD
    LOCAL clr:DWORD
    LOCAL okay:DWORD
    LOCAL dwColorStackIndex:DWORD
    LOCAL ptrColorStack:DWORD
    ...
    .IF okay
        ...
        mov clr, eax
        dec dwColorStackIndex ; dec dwStackTop
        Invoke MUISetIntProperty, hWin, @TextColorStackIndex, dwColorStackIndex
    .ELSE
        mov ebx, ptrColorStack ; get ptr to stack
...
; Returns in eax TRUE if success or FALSE if error
;------------------------------------------------------------------------------
ListStackPush PROC USES EBX ECX hWin:DWORD, dwListType:DWORD, dwItemIndent:DWORD, dwBulletIndent:DWORD
    LOCAL dwListStackIndex:DWORD
    LOCAL ptrListStack:DWORD
    ...
    Invoke MUIGetIntProperty, hWin, @TextPtrListStack
    .IF eax == 0
        mov eax, FALSE
        ret
    .ENDIF
    mov ptrListStack, eax

    Invoke MUIGetIntProperty, hWin, @TextListStackIndex
    mov dwListStackIndex, eax

    .IF eax < LISTSTACK_SIZE
        mov eax, dwListStackIndex
        mov ebx, SIZEOF LISTINFO
        mul ebx
        add eax, ptrListStack
        mov ebx, eax
        ...
        inc dwListStackIndex
        Invoke MUISetIntProperty, hWin, @TextListStackIndex, dwListStackIndex
    .ENDIF
    mov eax, TRUE
    ret
ListStackPush ENDP
...
; Returns in eax TRUE if success or FALSE if error
;------------------------------------------------------------------------------
ListStackPop PROC USES EBX ECX hWin:DWORD, lpdwListType:DWORD, lpdwItemIndent:DWORD, lpdwBulletIndent:DWORD
    LOCAL dwListStackIndex:DWORD
    LOCAL ptrListStack:DWORD
    LOCAL okey:DWORD
    LOCAL dwListType:DWORD
    ...
    .IF okey
        ...
        mov ebx, eax
    .ELSE
        mov ebx, ptrListStack ; get ptr to stack 
    .ENDIF
...
; Returns in eax TRUE if success or FALSE if error
;------------------------------------------------------------------------------
ListStackPeek PROC USES EBX ECX hWin:DWORD, lpdwListType:DWORD, lpdwItemIndent:DWORD, lpdwBulletIndent:DWORD
    LOCAL dwListStackIndex:DWORD
    LOCAL ptrListStack:DWORD
    LOCAL okey:DWORD
    LOCAL dwListType:DWORD
...
; Returns in eax TRUE if success or FALSE if error
;------------------------------------------------------------------------------
ListStackSetCounter PROC hWin:DWORD, dwValue:DWORD
    LOCAL okey:DWORD
    LOCAL dwListStackIndex:DWORD
    LOCAL ptrListStack:DWORD    
