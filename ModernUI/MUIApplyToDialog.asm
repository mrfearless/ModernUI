...
; WS_MAXIMIZE
;------------------------------------------------------------------------------
MUIApplyToDialogA PROC hWin:MUIWND, bDropShadow:BOOL, bClipping:BOOL
    LOCAL dwStyle:DWORD
    ...
    Invoke SetWindowLongA, hWin, GWL_STYLE, dwNewStyle
    ...
    .IF bDropShadow == TRUE
        ...
        .IF eax != CS_DROPSHADOW
            ...
            Invoke SetClassLongA, hWin, GCL_STYLE, dwClassStyle
        .ENDIF
    .ELSE    
        mov eax, dwClassStyle
        and eax, CS_DROPSHADOW
...
; WS_MAXIMIZE
;------------------------------------------------------------------------------
MUIApplyToDialogW PROC hWin:MUIWND, bDropShadow:BOOL, bClipping:BOOL
    LOCAL dwStyle:DWORD
    LOCAL dwNewStyle:DWORD
    LOCAL dwClassStyle:DWORD
    ...
    Invoke SetWindowLongW, hWin, GWL_STYLE, dwNewStyle
    
    ; Set dropshadow on or off on our dialog
    
    Invoke GetClassLongW, hWin, GCL_STYLE
    mov dwClassStyle, eax
    ...
    .IF bDropShadow == TRUE
        ...
        .IF eax != CS_DROPSHADOW
            or dwClassStyle, CS_DROPSHADOW
            Invoke SetClassLongW, hWin, GCL_STYLE, dwClassStyle
        .ENDIF
    .ELSE    
        mov eax, dwClassStyle
        and eax, CS_DROPSHADOW
